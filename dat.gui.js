                    ...
                    fakeEvent: function (e, t, n, o) {
                        ...
                        switch (r) {
                            ...
                            case "KeyboardEvents":
                                ...
                                a["default"].defaults(i, { cancelable: !0, ctrlKey: !1, altKey: !1, shiftKey: !1, metaKey: !1, keyCode: void 0, charCode: void 0 }),
            ...
            var u = n(7),
                ...
                v = (function (e) {
                    function t(n, o) {
                        ...
                        return (
                            g["default"].extend(v.__selector.style, { width: "122px", height: "102px", padding: "3px", backgroundColor: "#222", boxShadow: "0px 1px 3px rgba(0,0,0,0.3)" }),
                            ...
                            g["default"].extend(v.__hue_knob.style, { position: "absolute", width: "15px", height: "2px", borderRight: "4px solid #fff", zIndex: 1 }),
                            g["default"].extend(v.__saturation_field.style, { width: "100px", height: "100px", border: "1px solid #555", marginRight: "3px", display: "inline-block", cursor: "pointer" }),
                            g["default"].extend(w.style, { width: "100%", height: "100%", background: "none" }),
                            l(w, "top", "rgba(0,0,0,0)", "#000"),
                            g["default"].extend(v.__hue_field.style, { width: "15px", height: "100px", border: "1px solid #555", cursor: "ns-resize", position: "absolute", top: "3px", right: "3px" }),
                            s(v.__hue_field),
                            g["default"].extend(v.__input.style, { outline: "none", textAlign: "center", color: "#fff", border: 0, fontWeight: "bold", textShadow: v.__input_textShadow + "rgba(0,0,0,0.7)" }),
        ...
        function (e, t, n) {
            ...
            function _(e) {
                ...
                (e.__resize_handle = document.createElement("div")),
                    U["default"].extend(e.__resize_handle.style, { width: "6px", marginLeft: "-3px", height: "200px", cursor: "ew-resize", position: "absolute" }),
            ...
            var Y = "dg",
                ...
                oe = function ie(e) {
                    ...
                    o.autoPlace &&
                        (U["default"].isUndefined(o.parent) &&
                            ($ && ((ee = document.createElement("div")), z["default"].addClass(ee, Y), z["default"].addClass(ee, ie.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(ee), ($ = !1)),
                        ...
                        if (e.scrollable) {
                            ...
                            U["default"].each(e.__ul.childNodes, function (t) {
                                ...
                                window.innerHeight - t - W < n
                                    ? (z["default"].addClass(e.domElement, oe.CLASS_TOO_TALL), (e.__ul.style.height = window.innerHeight - t - W + "px"))
